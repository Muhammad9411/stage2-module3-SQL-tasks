...
INSERT INTO mark (subject_id, student_id, mark) VALUES (SELECT id from subject where name = 'Art', SELECT id from student where name = 'Chris', 8);
INSERT INTO mark (subject_id, student_id, mark) VALUES (SELECT id from subject where name = 'History', SELECT id from student where name = 'Oliver', 5);
INSERT INTO mark (subject_id, student_id, mark) VALUES (SELECT id from subject where name = 'Geography', SELECT id from student where name = 'James', 9);
INSERT INTO mark (subject_id, student_id, mark) VALUES (SELECT id from subject where name = 'Math', SELECT id from student where name = 'Jacob', 4);
INSERT INTO mark (subject_id, student_id, mark) VALUES (SELECT id from subject where name = 'PE', SELECT id from student where name = 'Logan', 9);
